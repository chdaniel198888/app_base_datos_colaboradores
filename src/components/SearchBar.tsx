...
import { Search, X, Filter, Loader2, User, Phone, Mail, MapPin, Briefcase, Building2, Calendar, Hash, Users } from 'lucide-react';
...
export function SearchBar() {
  ...
  // Función para obtener el teléfono prioritario
  const getPhoneNumber = (colaborador: any) => {
    return colaborador.celularCorporativo || colaborador.celular || '';
  };
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4">
      ...
      <div className="relative mb-6">
        ...
        {/* Indicador de estado */}
        {(query.length >= 2 || filters.centro_costo || filters.marca || filters.area) && (
      ...
      {showResults && (query.length >= 2 || filters.centro_costo || filters.marca || filters.area) && !isLoading && (
        <div className="space-y-4 animate-slide-in">
          {results.length > 0 ? (
            <>
              <p className="text-sm text-gray-600 font-medium">
                Mostrando {Math.min(20, results.length)} de {results.length} resultados
              </p>
                ...
                {results.slice(0, 20).map((colaborador) => (
                  ...
                  >
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-100 text-xs text-gray-500">
                      {colaborador.celularCorporativo && (
                        <p>📱 Corp: {colaborador.celularCorporativo}</p>
                      )}
                      {colaborador.celular && !colaborador.celularCorporativo && (
                        <p>📱 Personal: {colaborador.celular}</p>
                      )}
